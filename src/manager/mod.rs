...
pub trait Manager {
    /// Add a process with the specified pid to the cgroups.
    ...
    /// # Arguments
    ///
    /// - `subsystem`: cgroup subsystem, for cgroupsv1 the value should not
    ///   be empty, while for cgroupsv2 the only valid value is `None`.
